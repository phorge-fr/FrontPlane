...
The **SVC** cluster hosts all publicly accessible "self-hosted" service such as [OpenWebUI](https://github.com/open-webui/open-webui) or [Forgejo](https://forgejo.org/)
